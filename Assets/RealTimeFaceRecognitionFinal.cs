...
namespace RealTimeFaceRecognitionExample
{
    ...
    public class RealTimeFaceRecognitionFinal : MonoBehaviour
    {
        /// <summary>
        /// The texture.
        /// </summary>
        ...
        R_MODES m_mode = R_MODES.MODE_STARTUP;
        ...
        /// </summary>
        public void OnBackToHarvestButtonClick()
        {
            //Change scene
            #if UNITY_5_3 || UNITY_5_3_OR_NEWER
        ...
        private void _onMouseUP(int x, int y)
        {
           ...
           /* Debug.Log("User clicked on the image");
            ...
            if (clickedPerson >= 0)
            {
                ...
                m_mode = R_MODES.MODE_COLLECT_FACES;
            }
