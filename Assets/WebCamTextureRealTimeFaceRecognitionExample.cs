...
namespace RealTimeFaceRecognitionExample
{
    ...
    //const string eyeCascadeFilename2 = "haarcascade_eye_tree_eyeglasses.xml";
        ...
        /// <summary>
        /// Raises the OK button click event.
        /// </summary>
        public void OnAcceptButtonClick ()
        {
            Debug.Log ("User clicked [accept] button.");
            ...
            //Set static infos
            GameManager.instance.numberOfPersons = m_numPersons;

            //Change scene
            #if UNITY_5_3 || UNITY_5_3_OR_NEWER
            SceneManager.LoadScene ("FaceRecognitionInfos2Scene");
			#else
			Application.LoadLevel ("FaceRecognitionInfos2Scene");
			#endif
        }
